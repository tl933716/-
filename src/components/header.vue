...
<div class="">
			...
			<el-col :span="24">
				...
				<div class="headBox">
					<el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" @select="handleSelect" :router="true">
						...
						<el-menu-item index="/reward"><i class="fa fa-wa fa-users"></i>公告中心</el-menu-item>
	...
	<div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/BG4.png)'}">
		<div class="scene">
